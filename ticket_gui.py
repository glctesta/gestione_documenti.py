...
def _get_ticket_email(db) -> str:
    """Legge l'email destinataria da traceability_rs.dbo.settingrs."""
    query = "SELECT [value] FROM traceability_rs.dbo.settingrs WHERE Atribute = 'SysEmail_service_tickets'"
    try:
        with db._lock:
