# -*- coding: utf-8 -*-
"""
server_config.py — Configurazione del web server Kanban produzione.

Legge/crea `kanban_server_config.json` nella stessa directory dell'eseguibile
(o nella root del progetto in sviluppo).
"""
import os
import sys
import json
...
CONFIG_FILENAME = "kanban_server_config.json"
