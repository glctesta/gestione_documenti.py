...
TRANSLATIONS = [
    ...
    ('fqc_labelcode_required',
     'Inserire un LabelCode.',
     'Enter a LabelCode.',
     'Introduceti un LabelCode.',
     'Geben Sie einen LabelCode ein.',
     'Ange en LabelCode.'),

    ('fqc_verify_labelcode_first',
     'Verificare il LabelCode prima di salvare la checklist.',
     'Verify the LabelCode before saving the checklist.',
     'Verificati LabelCode inainte de a salva lista de verificare.',
     'Prüfen Sie den LabelCode, bevor Sie die Checkliste speichern.',
     'Verifiera LabelCode innan checklistan sparas.'),

    ('fqc_labelcode_not_found',
     'LabelCode non trovato nel database.',
     'LabelCode not found in database.',
     'LabelCode nu a fost gasit in baza de date.',
     'LabelCode wurde in der Datenbank nicht gefunden.',
     'LabelCode hittades inte i databasen.'),

    ('fqc_labelcode_mismatch',
     'Il LabelCode appartiene a un prodotto diverso',
     'LabelCode belongs to a different product',
     'LabelCode apartine unui alt produs',
     'Der LabelCode gehört zu einem anderen Produkt',
     'LabelCode tillhör en annan produkt'),

    ('fqc_labelcode_product_mismatch',
     'Il LabelCode non corrisponde più al prodotto selezionato. Verificare di nuovo.',
     'LabelCode no longer matches the selected product. Verify again.',
     'LabelCode nu mai corespunde produsului selectat. Verificati din nou.',
     'Der LabelCode passt nicht mehr zum ausgewählten Produkt. Bitte erneut prüfen.',
     'LabelCode matchar inte längre vald produkt. Verifiera igen.'),
